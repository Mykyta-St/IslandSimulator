...
@Config(fileName = "config/organism/animal/predator/Eagle.xml")
//@GameObject
public class Eagle extends Predator
{
                 ...
                 Area currentArea)
    {
        ...
        setHuntChances(eagleHuntChances());
    }

    @Override
    public Organism reproduce ()
    {
        return new Eagle(this.getMaxQuantity(),
