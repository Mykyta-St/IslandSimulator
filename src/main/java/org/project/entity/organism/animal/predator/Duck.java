...
@Config(fileName = "config/organism/animal/predator/Duck.xml")
@GameObject
public class Duck extends Predator
{
                  ...
                  Area currentArea)
    {
        ...
        setHuntChances(duckHuntChances());
    }

    @Override
    public Organism reproduce ()
    {
        return new Duck(this.getMaxQuantity(),
    ...
    private static Map<Class<? extends Organism>, Integer> duckHuntChances()
    {
