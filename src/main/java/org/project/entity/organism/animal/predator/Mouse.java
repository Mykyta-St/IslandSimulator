...
@Config(fileName = "config/organism/animal/predator/Mouse.xml")
@GameObject
public class Mouse extends Predator
{
                 ...
                 Area currentArea)
    {
        ...
        setHuntChances(mouseHuntChances());
    }

    @Override
    public Organism reproduce ()
    {
        return new Mouse(this.getMaxQuantity(),
    ...
    private static Map<Class<? extends Organism>, Integer> mouseHuntChances()
    {
        Map<Class<? extends Organism>, Integer> huntChances = new HashMap<>();
        huntChances.put(Worm.class, 90);
        huntChances.put(Rabbit.class, 0);
        huntChances.put(Goat.class, 0);
        huntChances.put(Sheep.class, 0);
        huntChances.put(Mouse.class, 0);
        huntChances.put(Duck.class, 0);
        ...
        huntChances.put(Grass.class, 100);
        huntChances.put(Cactus.class, 100);
        return huntChances;
    }
}