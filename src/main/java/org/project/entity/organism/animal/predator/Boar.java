...
@Config(fileName = "config/organism/animal/predator/Boar.xml")
@GameObject
public class Boar extends Predator
{
                 ...
                 Area currentArea)
    {
        ...
        setHuntChances(boarHuntChances());
    }

    @Override
    public Organism reproduce ()
    {
        return new Boar(this.getMaxQuantity(),
    ...
    private static Map<Class<? extends Organism>, Integer> boarHuntChances()
    {
        ...
        huntChances.put(Mouse.class, 50);
